    ...
    <div>
      ...
      <div>
        <Box sx={{ boxShadow: 3, borderRadius: 1, my: 1, p: 3 }}>
          <Typography>Google Tech</Typography>
          <Typography>India</Typography>
          <Typography sx={{ my: 2 }}>
            Learning is the <br /> "WISDOM"
          </Typography>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography>
              ...
              open, read, write, delete, and close files on the server Node.js
              can collect form data. Node.js can add, delete, modify data in
              your database.
            </Typography>
          </AccordionDetails>
        </Accordion>
